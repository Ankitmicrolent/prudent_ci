...
<head>
    <meta charset="utf-8"/>
    <title>Role Management | <?php echo project_name; ?> </title>
                        ...
                        <div class="portlet light">
                            <div class="portlet-title" style="background-color: #fff">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-blue bold uppercase">Role Management</span>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="portlet-title">
                                                    ...
                                                    <select class="form-control role_configuration select2me" name="name_of_role">
