...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
                        ...
                        <div class="col-md-12">
                            <div class="portlet light">
                                ...
                                <div class="portlet-body form">
                                    <form action="save_installed_wip_details" enctype="multipart/form-data" id="save_installed_wip_details"  method="post" class="horizontal-form">
            									...
            									<div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control" name="installed_wip_no" id="installed_wip_no" value="" placeholder="Installed WIP No" required="">
                                                        </div>
                                                    </div>
                                                </div>
            								</div>
    ...
    $(document).on('change', '#project_id', function() {
        ...
        if(project_id){
            ...
            $('#clientdciwipitemdisplay').dataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo base_url('get_dciwip_item_by_project'); ?>",
                        "type": "POST",
	...
	// Processing indicator
        ...
        "ajax": {
            "url": "<?php echo base_url('project_dciwip_list'); ?>",
            "type": "POST"
        },
