                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="col-md-2">
                                                        ...
                                                        <select class="form-control select2me" name="project_id" id="project_id" required>
                                                            ...
                                                            <?php if (isset($project_data) && !empty($project_data)) {
                                                                ...
                                                                foreach ($project_data as $key) { ?>
                                                                    ...
                                                                    <option value="<?php echo $key->project_id ?>" <?php echo (isset($perfoma_data->project_id) && !empty($perfoma_data->project_id) && ($perfoma_data->project_id == $key->project_id)) ? 'selected="selected"' : ''; ?>><?php echo $key->bp_code.'('.$key->customer_name.')'; ?></option>
                                                ...
                                                <!-- <div class="col-md-5">
            										<div class="form-groupp">
            											<label class="control-label">Select Project <span class="required" aria-required="true" style="color:#a94442">*</span></label>
            											<input type="text" class="form-control allprojects" id="project_id" name="project_id" value placeholder="Select Project Code" required>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control" name="proforma_invoice_no" id="proforma_invoice_no" value="<?php echo(isset($perfoma_data->proforma_no) && !empty($perfoma_data->proforma_no))?$perfoma_data->proforma_no:''?>" placeholder="Proforma Invoice No" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date date1" data-date-end-date="0d" data-date-format="dd-MM-yyyy">
                                                            <input type="text" name="invoice_date" id="invoice_date" value="<?php echo(isset($perfoma_data->created_on) && !empty($perfoma_data->created_on))?$perfoma_data->created_on:''?>" class="form-control" readonly="" placeholder="Proforma Invoice Date">
            ...
            if(gst_type == 'igst'){
                ...
                $('#proformainvcdisplay').dataTable({
                    ...
                    "ajax": {
                        ...
                        "url": "<?php echo base_url('get_proforma_by_projects'); ?>",
                        "type": "POST",
                        "data": {
