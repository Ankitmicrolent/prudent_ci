...
<head>
    <meta charset="utf-8"/>
    <title>Add BOQ Items | <?php echo project_name; ?> </title>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue">
                                        ...
                                        <span class="caption-subject bold uppercase"> Add BOQ Items</span>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <form action="save_boq_item_details" enctype="multipart/form-data" id="save_boq_item_details"  method="post" class="horizontal-form">
                                                ...
                                                <table width="100%" id="boqitmdisplay" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="min-width: 100px;width:100px;font-size:13px;">Item Description</th>
                                                            ...
                                                            <th style="min-width: 100px;width:100px;font-size:13px;">Rate Basic</th>
                                                            <th style="min-width: 50px;width:50px;font-size:13px;">GST %</th>
                                                            <th style="min-width: 50px;width:50px;font-size:13px;">Non-Sche</th>
    ...
    $(document).on('change', '#project_id', function() {
        ...
        if(project_id){
            ...
            $('#boqitmdisplay').dataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo base_url('get_boq_item_by_project'); ?>",
                        "type": "POST",
