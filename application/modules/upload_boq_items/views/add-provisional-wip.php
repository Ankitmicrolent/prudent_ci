...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
                        ...
                        <div class="col-md-12">
                            <div class="portlet light">
                                ...
                                <div class="portlet-body form">
                                    <form action="save_provisional_wip_details" enctype="multipart/form-data" id="save_provisional_wip_details"  method="post" class="horizontal-form">
            									...
            									<div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control" name="prov_wip_no" id="prov_wip_no" value="" placeholder="Provisional WIP No" required="">
                                                        </div>
                                                    </div>
                                                </div>
            								</div>
                                            <div id="displayPWIPItem" style="display:none;">
    ...
    $(document).on('change', '#project_id', function() {
        ...
        if(project_id){
            ...
            $('#clientdcpwipitemdisplay').dataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo base_url('get_dcpwip_item_by_project'); ?>",
                        "type": "POST",
	...
	// Processing indicator
        ...
        "ajax": {
            "url": "<?php echo base_url('project_dcpwip_list'); ?>",
            "type": "POST"
        },
