...

{
...

	{
		   ...
		   if (!empty($_FILES['home_addr_proof'])) {
		   ...
		   if(!empty($_FILES['native_addr_proof'])){
		   ...
		   if(!empty($_FILES['local_addr_proof'])){
		   ...
		   if(!empty($_FILES['perm_addr_proof'])){
		   ...
		   if(!empty($_FILES['drive_lic_proof'])){
		   ...
		   if(!empty($_FILES['passport_proof'])){
		...
		$data = array(
			...
			'home_addr_proof' => $home_ad_proof_file_path,
			'native_addr_proof' => $native_addr_proof_file_path,
			'local_addr_proof' => $local_addr_proof_file_path,
			'perm_addr_proof' => $perm_addr_proof_file_path,
			'drive_lic_proof' => $drive_lic_proof_file_path,
			'passport_proof' => $passport_proof_file_path,
			'pan_proof' => $pan_proof_file_path,
