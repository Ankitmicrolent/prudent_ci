...
<head>
    <meta charset="utf-8"/>
    <title>WIP Status | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase"><?php echo(isset($bp_code) && !empty($bp_code))?'(#'.$bp_code.')':''?> WIP Status</span>
                                </div>
                            ...
                            <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                    	...
                                    	<a role="presentation" href="<?php echo base_url(); ?>wip-status/<?php echo base64_encode($project_id); ?>" class="cm menu-item wip-status menu-item-active">WIP Status</a>
                                        </div>
                                    </div>
                                </nav>
                            <div class="tab-content">
                                ...
                                <div class="portlet-body form">
                                     <table width="100%" id="wipstatuslist" class="table table-striped table-bordered table-hover" style="font-size:12px;">
            							<thead>
            								<tr>
            									<th scope="col">Sr.no</th>
            									<th scope="col">BOQ Sr No</th>
            								    <th scope="col">Item Description</th>
            								    <th scope="col">Unit</th>
            								    <th scope="col">Design Qty</th>
            								    <th scope="col">BOQ Rate</th>
            								    <th scope="col">WIP 1 Qty</th>
            								    <th scope="col">WIP 1 Date</th>
            								    <th scope="col">WIP 1 No</th>
            								    <th scope="col">WIP 2 Qty</th>
            								    <th scope="col">WIP 2 Date</th>
            								    <th scope="col">WIP 2 No</th>
            								    <th scope="col">Total WIP Qty</th>
            								    <th scope="col">WIP Amount</th>
            								</tr>
            							</thead>
            							<tbody> 
            					    </table>
    ...
    $('#wipstatuslist').dataTable({
        ...
        "order": [],
		"ajax": {
            "url": "<?php echo base_url('project_wipstatus_list'); ?>",
            "type": "POST",
