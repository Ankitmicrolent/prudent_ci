...
<body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="portlet light">
                            ...
                            <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                    	...
                                    	<a role="presentation" href="<?php echo base_url(); ?>operational-scheduled/<?php echo base64_encode($project_id); ?>" class="cm menu-item boq-operational-view">BOQ Operational Scheduled View</a>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <?php for($i=0;$i<=$boq_transaction_cnt; $i++){ ?>
                                    <?php if($i == 0){ ?> 
                                    <p style="padding:10px 5px;background:#26a69a;color:#fff;font-size: 14px;font-weight: 600;">First Upload : </p>
                                    <?php }else{ ?>
                                    <hr/>
                                    <p style="margin-top:20px;padding:10px 5px;background:#26a69a;color:#fff;font-size: 14px;font-weight: 600;">Updation <?php echo $i; ?> : </p>
                                    <?php } ?>
                                    <input type="hidden" class="boq_transaction_cnt" value="<?php echo $i; ?>">
                                    <table width="100%" id="pboqlist<?php echo $i; ?>" class="table table-striped table-bordered table-hover">
            							<thead>
            								<tr>
            									<th scope="col" style="min-width:30px;width:30px;">Sr.no</th>
            									<th scope="col" style="min-width:80px;width:80px;">BP Code</th>
            								    <th scope="col" style="min-width:80px;width:80px;">BOQ Sr No</th>
            								    <th scope="col" style="min-width:250px;width:250px;">Item Description</th>
            									<th scope="col" style="min-width:30px;width:30px;">Unit</th>
            									<th scope="col" style="min-width:30px;width:30px;">Scheduled Qty</th>
            									<th scope="col" style="min-width:30px;width:30px;">Design Qty</th>
            									<th scope="col" style="min-width:30px;width:30px;">Rate Basic</th>
            									<th scope="col" style="min-width:30px;width:30px;">GST %</th>
            									<th scope="col" style="min-width:30px;width:30px;">Non-Scheduled</th>
            								</tr>
            							</thead>
            							<tbody> 
            					    </table>
                                <?php } }else{  ?>
                                <p style="margin-top:20px;">BOQ Transactions Not Found!!</p>
                                <?php } ?>
                                    </div>
                                </div>
                            </div>
    ...
    $(".boq_transaction_cnt").each(function(){
		var project_id = $('#project_id').val().trim(); 
    	var boq_transaction_cnt = $(this).val().trim(); 
    	$('#pboqlist'+boq_transaction_cnt).dataTable({
    	// Processing indicator
            ...
            "ajax": {
                "url": "<?php echo base_url('boq_transaction_display'); ?>",
                "type": "POST",
                "data":{boq_transaction_cnt:boq_transaction_cnt,project_id:project_id}
            },
