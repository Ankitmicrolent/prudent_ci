...
<head>
    <meta charset="utf-8" />
    <title><?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                echo 'Edit';
            } else {
                echo 'Create';
            } ?> OEF | <?php echo project_name; ?> </title>
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase"> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                        echo 'Edit';
                                                                                    } else {
                                                                                        echo 'Create';
                                                                                    } ?> OEF</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="dflx">
                                                                ...
                                                                <input type="radio" name="price_inslusive_of_amc" id="price_inslusive_of_amc_no" value="No" <?php echo (isset($create_project_data->price_inslusive_of_amc) && !empty($create_project_data->price_inslusive_of_amc) && ($create_project_data->price_inslusive_of_amc == 'No')) ? 'checked' : '' ?> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                                                                                                                                                                                                                                                                                                        echo '';
                                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                                        echo 'checked';
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="dflx">
                                                                ...
                                                                <input type="radio" name="is_billing_inter_state" id="is_billing_inter_state_no" value="No" <?php echo (isset($create_project_data->is_billing_inter_state) && !empty($create_project_data->is_billing_inter_state) && ($create_project_data->is_billing_inter_state == 'No')) ? 'checked' : '' ?> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                                                                                                                                                                                                                                                                                                        echo '';
                                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                                                                                                                                                                    } ?> required><span style="padding: 0 10px 0px 5px;">No</span>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="dflx">
                                                                ...
                                                                <input type="radio" name="insurance_req" id="insurance_no" value="No" <?php echo (isset($create_project_data->insurance_req) && !empty($create_project_data->insurance_req) && ($create_project_data->insurance_req == 'No')) ? 'checked' : '' ?> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                                                                                                                                                                                                                                                        echo '';
                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                                                                                                                    } ?> required><span style="padding: 0 10px 0px 5px;">No</span>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="dflx">
                                                                ...
                                                                <input type="radio" name="agreement_prepared" id="agreement_prepared_no" value="No" <?php echo (isset($create_project_data->agreement_prepared) && !empty($create_project_data->agreement_prepared) && ($create_project_data->agreement_prepared == 'No')) ? 'checked' : '' ?> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                                                                                                                                                                                                                                                                                    echo '';
                                                                                                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                                                                                                                                                } ?> required><span style="padding: 0 10px 0px 5px;">No</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="dflx">
                                                                ...
                                                                <input type="radio" name="invoice_submitted" id="invoice_submitted_no" value="No" <?php echo (isset($create_project_data->invoice_submitted) && !empty($create_project_data->invoice_submitted) && ($create_project_data->invoice_submitted == 'No')) ? 'checked' : '' ?> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                                                                                                                                                                                                                                                                                echo '';
                                                                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                                                                echo 'checked';
                                                                                                                                                                                                                                                                                                                                            } ?> required><span style="padding: 0 10px 0px 5px;">No</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="dflx">
                                                                ...
                                                                <input type="radio" name="invoice_submitted_address" id="invoice_submitted_address_no" value="No" <?php echo (isset($create_project_data->invoice_submitted_address) && !empty($create_project_data->invoice_submitted_address) && ($create_project_data->invoice_submitted_address == 'No')) ? 'checked' : '' ?> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                                                                                                                                                                                                                                                                                                                        echo '';
                                                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                                                                                                                                                                                    } ?> required><span style="padding: 0 10px 0px 5px;">No</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="dflx">
                                                                ...
                                                                <input type="radio" name="esic_required" id="esicNo" value="No" <?php echo (isset($create_project_data->esic_required) && !empty($create_project_data->esic_required) && ($create_project_data->esic_required == 'No')) ? 'checked' : '' ?> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                                                                                                                                                                                                                                                echo '';
                                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                                echo 'checked';
                                                                                                                                                                                                                                                                                                            } ?> required><span style="padding: 0 10px 0px 5px;">No</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="dflx">
                                                                ...
                                                                <input type="radio" name="pf_required" id="pfNo" value="No" <?php echo (isset($create_project_data->pf_required) && !empty($create_project_data->pf_required) && ($create_project_data->pf_required == 'No')) ? 'checked' : '' ?> <?php if (isset($create_project_data->create_project_id) && !empty($create_project_data->create_project_id)) {
                                                                                                                                                                                                                                                                                                        echo '';
                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                                                                                                    } ?> required><span style="padding: 0 10px 0px 5px;">No</span>
