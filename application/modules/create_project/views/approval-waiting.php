...
<head>
    <meta charset="utf-8"/>
    <title>Waiting for approval | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase"><?php echo(isset($bp_code) && !empty($bp_code))?'(#'.$bp_code.')':''?> Waiting for Approval</span>
                                </div>
                            ...
                            <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                        <div class="menu" style="transform: translateX(-88%);">
                                    	...
                                    	<a role="presentation" href="<?php echo base_url(); ?>approval-waiting/<?php echo base64_encode($project_id); ?>" class="cm menu-item menu-item-active waiting-approval">Waiting for Approval</a>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="portlet-body form">
                                    <table width="100%" id="waitinigapprlist" class="table table-striped table-bordered table-hover">
            							<thead>
            								<tr>
    ...
    $('#waitinigapprlist').dataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('project_waiting_approv_list'); ?>",
            "type": "POST",
