...
<body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="portlet light">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <p style="padding:10px 5px;background:#26a69a;color:#fff;font-size: 14px;font-weight: 600;">View Operable Scheduled A : </p>
                                    <table width="100%" id="pboqscha" class="table table-striped table-bordered table-hover">
            							<thead>
            								<tr>
            									...
            									<th scope="col" style="min-width:30px;width:30px;">Operable Qty</th>
            								</tr>
            							</thead>
            							<tbody> 
            					    </table>
            					    <hr/>
                                    <p style="padding:10px 5px;background:#26a69a;color:#fff;font-size: 14px;font-weight: 600;">View Operable Scheduled B+ : </p>
                                    <table width="100%" id="pboqschb" class="table table-striped table-bordered table-hover">
            							<thead>
            								<tr>
            									...
            									<th scope="col" style="min-width:30px;width:30px;">Unit</th>
            									<th scope="col" style="min-width:30px;width:30px;">Scheduled Qty</th>
            									<th scope="col" style="min-width:30px;width:30px;">Variation Qty</th>
            								</tr>
            							</thead>
            							<tbody> 
            					    </table>
                                    ...
                                    <hr/>
                                    <p style="padding:10px 5px;background:#26a69a;color:#fff;font-size: 14px;font-weight: 600;">View Operable Scheduled C : </p>
	...
	// Processing indicator
        ...
        "ajax": {
            "url": "<?php echo base_url('boq_scha_list_display'); ?>",
            "type": "POST",
	...
	// Processing indicator
        ...
        // Load data from an Ajax source
        "ajax": {
            "url": "<?php echo base_url('boq_schb_list_display'); ?>",
            "type": "POST",
            "data":{project_id:project_id}
        },
	...
	// Processing indicator
        ...
        // Load data from an Ajax source
        "ajax": {
            "url": "<?php echo base_url('boq_schbn_list_display'); ?>",
            "type": "POST",
            "data":{project_id:project_id}
        },
	...
	// Processing indicator
        ...
        // Load data from an Ajax source
        "ajax": {
            "url": "<?php echo base_url('boq_schc_list_display'); ?>",
            "type": "POST",
            "data":{project_id:project_id}
        },
