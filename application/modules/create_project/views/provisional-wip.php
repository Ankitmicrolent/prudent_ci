...
<head>
    <meta charset="utf-8"/>
    <title>Provisional WIP | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase"><?php echo(isset($bp_code) && !empty($bp_code))?'(#'.$bp_code.')':''?> Provisional WIP</span>
                                </div>
                            ...
                            <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                        <div class="menu" style="transform: translateX(-37%);">
                                    	...
                                    	<a role="presentation" href="<?php echo base_url(); ?>provisional-wip/<?php echo base64_encode($project_id); ?>" class="cm menu-item provisional-wip menu-item-active">Provisional WIP</a>
                                    ...
                                    <table width="100%" id="pwiplist" class="table table-striped table-bordered table-hover" style="font-size:12px;">
            							<thead>
            								<tr>
            								    ...
            								    <th scope="col">Provisional WIP Qty</th>
            								</tr>
            							</thead>
            							<tbody> 
            					    </table>
    ...
    $('#pwiplist').dataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('project_dcpwip_list_p'); ?>",
            "type": "POST",
