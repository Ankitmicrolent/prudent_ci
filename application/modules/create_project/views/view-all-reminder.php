...
<head>
    <meta charset="utf-8"/>
    <title>All Reminder | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase"><?php echo(isset($bp_code) && !empty($bp_code) && !empty($project_id))?'(#'.$bp_code.') All Reminder':'All Reminder'?></span>
                                </div>
                            ...
                            <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                        <div class="menu">
                                        <a role="presentation" href="<?php echo base_url(); ?>project-details/<?php echo base64_encode($project_id); ?>" class="cm menu-item">Project Details</a>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="view-reminder">
                                <input type="hidden" id="project_id" value="<?php echo base64_encode($project_id); ?>">
                                <div class="portlet-body form">
                                    <table width="100%" id="allreminderlist" class="table table-striped table-bordered table-hover">
            							<thead>
            								<tr>
            									<th scope="col" style="min-width:50px;width:50px;">Sr.no</th>
            									<th scope="col" style="min-width:350px;width:350px;">Reminder</th>
    ...
    $('#allreminderlist').dataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('all_reminder_list'); ?>",
            "type": "POST",
