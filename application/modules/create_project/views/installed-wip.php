...
<head>
    <meta charset="utf-8"/>
    <title>Installed WIP | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase"><?php echo(isset($bp_code) && !empty($bp_code))?'(#'.$bp_code.')':''?> Installed WIP</span>
                                </div>
                            ...
                            <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                        <div class="menu" style="transform: translateX(-22%);">
                                    	...
                                    	<a role="presentation" href="<?php echo base_url(); ?>installed-wip/<?php echo base64_encode($project_id); ?>" class="cm menu-item installed-wip menu-item-active">Installed WIP</a>
                                    ...
                                    <table width="100%" id="iwiplist" class="table table-striped table-bordered table-hover" style="font-size:12px;">
            							<thead>
            								<tr>
            								    ...
            								    <th scope="col">Installed WIP Qty</th>
            								</tr>
            							</thead>
            							<tbody> 
            					    </table>
    ...
    $('#iwiplist').dataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('project_dciwip_list_p'); ?>",
            "type": "POST",
