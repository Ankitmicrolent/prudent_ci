...
<head>
    <meta charset="utf-8"/>
    <title>WIP Status Report | <?php echo project_name; ?> </title>
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase">WIP Status</span>
                                </div>
                            </div>
                            <div class="portlet-body form">
            					...
            					<div class="row" style="margin-top:20px;">
            						<div class="col-md-3">
            						    <div class="form-group">
            						    	<div class="input-group date date1" data-date-end-date="0d" data-date-format="dd-MM-yyyy">
            							        <input type="text" name="from_date" id="from_date" class="form-control" readonly="" placeholder="From Date">		
            						...
            						<div class="col-md-3">
            						    <div class="form-group">
            						    	<div class="input-group date date1" data-date-end-date="0d" data-date-format="dd-MM-yyyy">
            							        <input type="text" name="to_date" id="to_date" class="form-control" readonly="" placeholder="To Date">		
            							        <span class="input-group-btn">
            							            <button class="btn default" type="button"><span class="md-click-circle md-click-animate" style="height: 47px; width: 47px; top: -1.0625px; left: -9.5px;"></span><i class="fa fa-calendar"></i></button>
            							        </span>
            							    </div>
                                ...
                                <table width="100%" id="wipstatusreports" class="table table-striped table-bordered table-hover">
        							<thead>
        									<tr>
        									...
        									<th scope="col" style="min-width:50px;width:50px;">Installed Opening</th>
        									<th scope="col" style="min-width:50px;width:50px;">Installed Added</th>
        									<th scope="col" style="min-width:50px;width:50px;">Installed Closing</th>
        									<th scope="col" style="min-width:50px;width:50px;">Billed</th>
        								</tr>
        							</thead>
        							<tbody> 
        					    </table>
