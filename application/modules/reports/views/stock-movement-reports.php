                            ...
                            <div class="portlet-body form">
                                ...
                                <table width="100%" id="wipstatusreports" class="table table-striped table-bordered table-hover">
        							<thead>
        									...
        									<th scope="col" style="min-width:50x;width:50x;">BOQ Rate</th>
        									<th scope="col" style="min-width:150px;width:150px;">Item Description</th>
        									<th scope="col" style="min-width:50px;width:50px;">Opening Stock</th>
        									<th scope="col" style="min-width:50px;width:50px;">Added Stock</th>
        									<th scope="col" style="min-width:50px;width:50px;">Consumed Stock</th>
        									<th scope="col" style="min-width:50px;width:50px;">Closing Stock</th>
        								</tr>
        							</thead>
        							<tbody> 
        					    </table>
