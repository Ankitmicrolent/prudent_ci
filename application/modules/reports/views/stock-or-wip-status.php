...
<head>
    <meta charset="utf-8"/>
    <title>Stock / WIP Summary Detail | <?php echo project_name; ?> </title>
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase">Stock / WIP Summary Detail</span>
                                </div>
                            </div>
            						...
            						<div class="col-md-2">
                                        <div class="form-group">
                                            <select class="form-control" name="rate_type" id="rate_type" required>
                                                <option value="boq_rate">BOQ Rate</option>
                                                <option value="bom_rate">BOM Rate</option>
                                            </select>
                                        </div>
                                    </div>
            					</div>
            					<div class="" style="margin-top:20px;" id="commomtablediv">
                                <table width="100%" id="commomtable" class="table table-striped table-bordered table-hover">
        							<thead>
        								<tr>
