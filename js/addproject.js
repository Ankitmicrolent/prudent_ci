     $(document).on("change","#per_payment_mode", function(){
        ...
        if(value == 'bank_guarantee'){
            var html = '<div class="form-group">'
                +'<label class="">SD-PBG-FD <span class="require" aria-required="true" style="color:#a94442">*</span></label>'
                +'<div class="input-icon right">'
                +'<i class="fa"></i>'
                +'<input type="text" class="form-control " name="sd_pbg_fd" id="sd_pbg_fd" placeholder="SD-PBG-FD">'
                +'</div>';
                $('#sd_pbg_fd').html(html);    
        }else{
            $('#sd_pbg_fd').html('');    
    ...
    $(document).ready(function(){
            ...
            $(document).on('click','.adinspectionbtn',function(){
                ...
                +'<div class="input-icon right"><i class="fa"></i>'
                +'<input type="hidden" id="smcnt" value="1">'
                +'<input type="text" class="form-control" name="inspection_text[]" id="inspection_text'+inspection+'" value="" placeholder="Inspection '+inspection+'" required="">'
        	    +'</div>'
                +'</div><div class="" style="width: 10%;">'
            ...
            $(document).on('click','.adsprotobtn',function(){
                ...
                +'<div class="input-icon right"><i class="fa"></i>'
                +'<input type="hidden" id="prcnt" value="1">'
                +'<input type="text" class="form-control" name="prototype_text[]" id="prototype_text'+prototypet+'" value="" placeholder="Prototype '+prototypet+'" required="">'
        	    +'</div>'
                +'</div><div class="" style="width: 10%;">'
            ...
            $(document).on('click','.adsamplebtn',function(){
                ...
                +'<div class="form-group" style="width: 90%;">'
                +'<div class="input-icon right"><i class="fa"></i>'
                +'<input type="text" class="form-control" name="sample_text[]" id="sample_text'+sample+'" value="" placeholder="Sample '+sample+'" required="">'
                +'</div>'
                +'</div><div class="" style="width: 10%;">'
            ...
            $(document).on('click','.adfatbtn',function(){
                ...
                +'<div class="input-icon right"><i class="fa"></i>'
                +'<input type="hidden" id="prcnt" value="1">'
                +'<input type="text" class="form-control" name="fat_text[]" data-id="fat_id" id="fat_text'+fat+'" value="" placeholder="FAT '+fat+'" required="">'
        	    +'</div>'
                +'</div><div class="" style="width: 10%;">'
        	...
        	$(document).on('click','.adsatbtn',function(){
                ...
                +'<div class="form-group" style="width: 90%;">'
                +'<div class="input-icon right"><i class="fa"></i>'
                +'<input type="text" class="form-control" name="sat_text[]" id="sat_text'+sat+'" value="" placeholder="SAT '+sat+'" required="">'
        	    +'</div>'
                +'</div><div class="" style="width: 10%;">'
        	...
        	$(document).on('click', '.adbtn', function() {
                ...
                insurance_required_doc !=='' && typeof insurance_required_doc != 'undefined'){
                var html = '<div class="row dflxd">'
        	    +'<div class="col-md-6"><div class="form-group">'
        	    +'<div class="input-icon right">'
        	    +'<i class="fa"></i><input type="text" class="form-control " name="insurance_remark[]" id="insurance_remark'+cnt+'" value="" placeholder="Insurance Details" required="">'
                +'</div></div></div>'
                +'<div class="col-md-3">'
                ...
                +'<input type="text" name="insurance_up_to_date[]" id="insurance_up_to_date'+cnt+'" class="form-control" placeholder="dd-mm-yyyy" value="" readonly="" required="">'
                ...
                +'<div class="input-icon right">'
                +'<i class="fa"></i>'
                +'<input type="text" class="form-control " name="amount_of_risk_cov[]" id="amount_of_risk_cov'+cnt+'" placeholder="Amount Of Risk Coverage" required="">'
                +'</div></div></div>'
                +'<div class="col-md-3">'
                +'<div class="form-group">'
                +'<input type="file" name="insurance_required_doc[]" id="insurance_required_doc'+cnt+'" class="insurance_required_doc" accept=".xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf" required="">'
                +'</div></div>'
                +'<div class="col-md-1">'
                +'<div class="rmbtn"><i class="fa fa-minus" aria-hidden="true" style="font-size:10px;"></i></div>'
                +'</div></div>';
        		$("#nsuranceRequiredApp").append(html);
        ...
        $(function () {
            ...
            $("input[name='agreement_prepared']").click(function () {
                if ($("#agreement_prepared_yes").is(":checked")) {
                    ...
                    +'<div class="form-group">'
                    +'<label class="control-label">Signed Agreement Document Upload  <span class="require" aria-required="true" style="color:#a94442">*</span></label><br>'
            ...
            $("input[name='insurance_req']").click(function () {
                if ($("#insurance_yes").is(":checked")) {
                    ...
                    +'<div class="col-md-3">'
                    +'<div class="form-group">'
                    +'<label class="">Upload Insurance <br> Documment <span class="require" aria-required="true" style="color:#a94442">*</span></label>'
            ...
            $("input[name='invoice_submitted_address']").click(function () {
                if ($("#invoice_submitted_address_yes").is(":checked")) {
                    ...
                    +'<div class="input-icon right"><i class="fa"></i>'
                    +'<textarea rows="2" type="text" class="form-control" name="invoice_submitted_address_text" id="invoice_submitted_address_text" placeholder="Invoice to be sent on different address" required></textarea>'
                    +'</div></div></div>';
                    cntwa++;
                    if(cntwa == 1){
                    $("#daddde").append(html);
...
// Ankit changes
            ...
            $("input[name='performance_paid']").click(function () {
                if ($("#performance_paid").is(":checked")) {
                    ...
                    +'<div class="form-group">'
                    +'<label class="">Payment Mode <span class="require" aria-required="true" style="color:#a94442">*</span></label>'
                    +'<select class="form-control select2me" name="per_payment_mode" id="per_payment_mode" required>'
                    +'<option value="">Select</option>'
                    ...
                    +'<div class="form-group">'
                    +'<label class="control-label">Upload Final Bond Document <span class="require" aria-required="true" style="color:#a94442">*</span></label><br>'
